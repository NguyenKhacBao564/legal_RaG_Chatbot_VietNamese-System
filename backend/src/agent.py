...
class OpenAICompatibleLLM(OpenAI):
    """OpenAI-compatible LLM wrapper for providers with non-OpenAI model names."""

    @property
    def metadata(self) -> LLMMetadata:
        return LLMMetadata(
            context_window=int(os.environ.get("LLM_CONTEXT_WINDOW", "1048576")),
...
llm_cls = OpenAICompatibleLLM if llm_base_url else OpenAI
